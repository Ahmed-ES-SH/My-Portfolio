  ...
  return (
    <div className="flex max-md:flex-col  gap-4">
      ...
      <motion.a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center gap-2 px-6 py-3 bg-linear-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-medium hover:scale-[105%] duration-300 shadow-lg"
      >
